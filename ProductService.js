 ...
 */
export async function getProductList(page = 1, pageSize = 50, keyword = '') {
  try {
    // 쿼리 파라미터 생성
 ...
 * @param {Array<string>} productData.tags - 해시태그 배열
 * @param {Array<string>} productData.images - 이미지 배열
